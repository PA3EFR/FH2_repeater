...
// ---------------------------------------------------------------------------
#define PIN_S3           5   // Nano D2: MUX S0
#define PIN_S2           4   // Nano D3: MUX S1
#define PIN_S1           3   // Nano D4: MUX S2
#define PIN_S0           2   // Nano D5: MUX S3
...
void printHeader() {
    ...
    Serial.println(F("  D6 = Repeat schakelaar (GND=uit)"));
    Serial.println(F("  D7 = Puls LED"));
    Serial.println(F("  D8 = Status LED (GROEN)"));
    Serial.println();
}
